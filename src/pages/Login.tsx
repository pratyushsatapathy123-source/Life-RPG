...
export function Login() {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      setError('Could not send password reset email. Please verify your email address.');
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f9f9fb] p-4">
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-zinc-200/60 w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-zinc-900">Welcome</h1>
          <p className="text-sm text-zinc-500 mt-1">Log in to continue your adventure.</p>
        </div>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <button 
            ...
            className="w-full flex items-center justify-center gap-2 bg-amber-600 hover:bg-amber-700 text-white py-2.5 rounded-lg font-semibold transition-colors disabled:opacity-50 mt-2"
          >
        ...
        <div className="mt-4 text-center">
          <button 
            ...
            className="text-sm text-zinc-500 hover:text-amber-600 font-medium transition-colors"
          >
