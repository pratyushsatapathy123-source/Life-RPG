...
const correctCode = `import React, { createContext, useContext, useEffect, useState, ReactNode } from 'react';
...
fs.writeFileSync('src/contexts/PlayerContext.tsx', correctCode);
